...
if(platform.system()=="Windows"):		# MB Jan2020 For Windows
    os_slash = "\\"						# MB Jan2020
else:									# MB Jan2020
    os_slash = "/"						# MB Jan2020
...
def get_putative_hg_list(init_hg, hg, df_haplogroup_trimmed, df_haplogroup_all):
    ...
    dict_hg = {}
    list_hg_remove = []
    hg_threshold = 0.7				# MB Jan2020 relaxed from 0.8 in orig
...
def process_keys(keys):
    ...
    '''for i in tmp_hg:						# MB Jan2020 
        if i in keys:
            index = keys.index(i)
            keys.pop(index)'''				# MB Jan2020
    return keys, tmp_hg
...
if __name__ == "__main__":
    ...
    hg_intermediate = home_source+os_slash+"Hg_Prediction_tables"+os_slash    	# MB Jan2020 for Windows
    ...
    for sample_name in samples:
        ...
        # Also save a less strict haplogroup prediction, as the former one often	MB Jan2020
        # misses the real terminal haplogroup										MB Jan2020
        fp = open(out_file + "tmp_hg.txt","w")									  # MB Jan2020
