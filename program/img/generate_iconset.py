...
Single .png parameter of an 300dpi, at least 512x512 image 
It creates the Apple iconsets needed from that image
Doc: https://retifrav.github.io/blog/2018/10/09/macos-convert-png-to-icns/
"""
import os
import sys
import pathlib
